...
BOT_TOKEN = "6697904876:AAHV5THX4yTtAtnEY06tqjsTZZdQJ2nMwKY"
    ...
    try:
        for i in range(arg, len(links)):
            ...
            if "acecwply" in url:
            	...
            	headers = {'Host': 'api.classplusapp.com', 'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..mEDsf-3KHTTbvWJcAFWBj1RxKw7da90BHLG1uACxmVUQoYwszIYKVVcdVoJ1cKqL', 'user-agent': 'Mobile-Android', 'app-version': '1.4.37.1', 'api-version': '18', 'device-id': '5d0d17ac8fhb3c9f51', 'device-details': '2848b866799971ca_2848b8667a33216c_SDK-30', 'accept-encoding': 'gzip'}
            	params = (('url', f'{url}'),)
