...
async def account_login(bot: Client, m: Message):
    ...
    try:
        while processed_count < len(links):
            while len(tasks) < max_concurrent_threads and processed_count < len(links):
                link = links[processed_count]
