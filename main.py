                    ...
                    if 'ETA' in line:
                       ...
                       try:
                          ...
                          if percentage >= 30 and not percentage_30_reached:
                               ...
                               boom3 = await m.reply_text("Downloading **30%**")
                               prog3 = await m.reply_text(boom3)
                               percentage_30_reached = True
                          if percentage >= 40 and not percentage_40_reached:
                               await prog3.delete(True)
                               boom4 = await m.reply_text("Downloading **40%**")
                               prog4 = await m.reply_text(boom4)
                               percentage_40_reached = True
                          if percentage >= 50 and not percentage_50_reached:
                               await prog4.delete(True)
                               boom5 = await m.reply_text("Downloading **50%**")
                               prog5 = await m.reply_text(boom5)
                               percentage_50_reached = True
                          if percentage >= 60 and not percentage_60_reached:
                               await prog5.delete(True)
                               boom6 = await m.reply_text("Downloading **60%**")
                               prog6 = await m.reply_text(boom6)
                               percentage_60_reached = True
                          if percentage >= 70 and not percentage_70_reached:
                               await prog6.delete(True)
                               boom7 = await m.reply_text("Downloading **70%**")
                               prog7 = await m.reply_text(boom7)
                               percentage_70_reached = True
                          if percentage >= 80 and not percentage_80_reached:
                               await prog7.delete(True)
                               boom8 = await m.reply_text("Downloading **80%**")
                               prog8 = await m.reply_text(boom8)
                               percentage_80_reached = True
                          if percentage >= 90 and not percentage_90_reached:
                               await prog8.delete(True)
                               boom9 = await m.reply_text("Downloading **90%**")
                               prog9 = await m.reply_text(boom9)
                               percentage_90_reached = True
                          if percentage >= 100 and not percentage_100_reached:
                               await prog9.delete(True)
                               boom10 = await m.reply_text("Downloading **100%**")
                               prog10 = await m.reply_text(boom10)
