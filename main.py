...
async def account_login(bot: Client, m: Message):
    ...
    if raw_text2 == '1280' or (raw_text2.isdigit() and 1200 <= int(raw_text2) <= 1300):
       format_filter = 'bestvideo[height>=1200][height<=1300]+bestaudio/best[height>=1200][height<=1300]'
    elif raw_text2 == '854' or (raw_text2.isdigit() and 800 <= int(raw_text2) <= 900):
       format_filter = 'bestvideo[height>=800][height<=900]+bestaudio/best[height>=800][height<=900]'
    elif raw_text2 == '720' or (raw_text2.isdigit() and 700 <= int(raw_text2) <= 800):
       format_filter = 'bestvideo[height>=700][height<=800]+bestaudio/best[height>=700][height<=800]'
    elif raw_text2 == '480' or (raw_text2.isdigit() and 400 <= int(raw_text2) <= 500):
       format_filter = 'bestvideo[height>=400][height<=500]+bestaudio/best[height>=400][height<=500]'
    elif raw_text2 == '360' or (raw_text2.isdigit() and 300 <= int(raw_text2) <= 400):
       format_filter = 'bestvideo[height>=300][height<=400]+bestaudio/best[height>=300][height<=400]'
    elif raw_text2 == '240' or (raw_text2.isdigit() and 200 <= int(raw_text2) <= 300):
       format_filter = 'bestvideo[height>=200][height<=300]+bestaudio/best[height>=200][height<=300]'
    elif raw_text2 == '188' or (raw_text2.isdigit() and 100 <= int(raw_text2) <= 200):
       format_filter = 'bestvideo[height>=100][height<=200]+bestaudio/best[height>=100][height<=200]'
    else:
       format_filter = 'best'
