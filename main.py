                    ...
                    if 'ETA' in line:
                       ...
                       try:
                          ...
                          if percentage >= 20 and not percentage_20_reached:
                               ...
                               await editable2.edit("Downloading **20%**")
                          ...
                          if percentage >= 40 and not percentage_40_reached:
                               #print("40% reached! ❤")
                               await editable1.delete(True)
                               await editable2.edit("Downloading **40%**")
                          ...
                          if percentage >= 60 and not percentage_60_reached:
                               #print("60% reached! ❤")
                               await editable1.delete(True)
                               await editable2.edit("Downloading **60%**")
                          ...
                          if percentage >= 80 and not percentage_80_reached:
                               #print("80% reached! ❤")
                               await editable1.delete(True)
                               await editable2.edit("Downloading **80%**")
                          ...
                          if percentage >= 100 and not percentage_100_reached:
                               #print("Completed! ❤")
                               await editable1.delete(True)
                               await editable2.edit("Downloading **100%** Completed")
